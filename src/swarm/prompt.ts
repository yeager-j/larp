...
const SWARM_PROTOCOL =
  "You participate in a LARP swarm with your Role's file permissions. Do not start other LARP commands. Your final answer is the result; LARP writes it to disk. There is no interactive caller during this Turn. Resolve routine ambiguity from evidence and state any limitations.";
